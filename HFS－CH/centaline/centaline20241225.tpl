...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#fcfbfb"><img src="http://10.6.15.3:8080/centaline/guoqing.jpg" width="100%" height="118" /></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><marquee width=1280 behavior=alternate direction=left align=middle border=1 onmouseover="this.stop()" onMouseOut="this.start()">温馨提示：微信3.95.90版本更新于2024-07-24，企业微信4.0.20更新于2024-04-04！</marquee></td>
  </tr>
</table>
<div id="heading">
%login-link%
...
<script type="text/javascript">
 if ("%folder%" == "/") {
 document.getElementById('title').innerHTML = "软件下载商店";
 document.title = "软件下载商店";
}
</script>
</div>
<div class="grid">
...
#heading { padding:1.3em; background-color: #bbb9df; }
...
<div class="button">|<a href="http://10.6.2.218:9009/?lang=zh" title="使用google浏览器绘制户型平面图,流程图等！" "target="_blank">绘制平面图</a>|</div>
<div class="button">|<a href="http://10.6.2.105/" target="_blank">简易PS在线工具</a>|</div>
<div class="button">|<a href="http://10.6.2.103/?lang=zh_CN" title="此PDF工具建议使用google浏览器" target="_blank">在线PDF编辑工具</a>|</div>
<div class="button">|<a href="http://centamsntab/centahelp/ithelper.aspx" target="_blank" title="如果需要工程师帮助！请报故障平台！

海信南方大厦    曾海维 13723789240   杨松子 13798226906

东部湾区| 布吉平湖区 | 莲塘区 | 沙头角区 | 布吉横岗区：屈顺华 8520 13600168062

罗湖中区 | 罗湖南区| 罗湖北区|罗湖西及白沙岭区| 环中区市场营销部|  傅永裕 8518 13430976258 

宝城区 | 会展湾区 | 前海自贸区：屈顺华 8520 13600168062 傅永裕 8518 13430976258 

福田南区 | 华侨城区 西丽区 |   张剑生 8519 13713761074 

龙岗中心城北区 | 龙岗中心城南区 | 坂田观澜区|龙华区：肖伟荣 8522 15817407618 ">IT故障平台 </a>|</div>
<div class="button">|<a href="http://10.6.1.121/index3.htm" target="_blank">公司导航</a>|</div>
[loggedin]
...
[nofiles]
<p class="error"><a href="%parent-folder%">这家伙很懒！什么都没有上传..，点击返回首页！</a></p>
...
<th style="width:47%;"><a href="%encoded-folder%?sort=n">软件文件名</a></th>

<th style="width:15%"><a href="%encoded-folder%?sort=s">文件大小（MB）</a></th>
<th style="width:23%"><a href="%encoded-folder%?sort=t"><label title="软件版本更新日期">软件版本更新日期</label></a></th>
<th style="9%; text-align:right"><label title="下载运行次数">下载量</label></th>
</tr>
</thead>
<tbody>
%list%
...
<table width="800" height="" border="0" cellspacing="0" cellpadding="0" background="">
  <tr>
    <td align="center">信息技术中心 ＠ 运维组维护</td>
  </tr>
</table>
<!--<iframe width=275 height=370 frameborder=0 scrolling=no src=http://centamsntab/centahelp/ithelper.aspx></iframe> -->
[file]
...
[newfile]
 class="new"
[folder-comment]
<div style='background: white; color: black; width: 59.5em; margin-bottom: 0.8em; padding:0.6em; border:1px solid orange;'>%item-comment%</div>
...
<div class="grid">
<div style='background: white; color: black; width: 59.5em; margin-bottom: 0.8em; padding:0.6em; border:1px solid orange;'>Files uploaded:</div>
<table id="filelist">
<thead>
<tr>
